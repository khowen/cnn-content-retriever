...
class ContentRetriever {
    ...
    getRecentPublishes(limit, contentTypes, dataSources, timestamp) {
        ...
        const self = this,
            ...
            url = `${self.hypatiaHost}${self.hypatiaRoute}${typeQuery}${dataSourceQuery}${limitQuery}${timestampQuery}sort:lastModifiedDate`,
    ...
    /**
     * Loops though an array of relatedMedia to fetch any referenced data.
     *
     * @private
     *
     * @param {Object} data
                    ...
                    switch (media.referenceType) {
                        ...
                        case 'video':
                            ...
                            self.getVideoReferenceModel(media.referenceUrl).then(
                                ...
                                debugLog(`Error getRelatedContent::getVideoReferenceModel::success ${error.stack}`);
                                callbackEachSeries(error);
                            });
                            break;
